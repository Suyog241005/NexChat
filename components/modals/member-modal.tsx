...
const roleIconMap = {
  ...
  [MemberRole.MODERATER]: <ShieldCheck className="h-4 w-4 ml-2 text-indigo-500" />,
                      ...
                      <DropdownMenuSub>
                        ...
                        <DropdownMenuPortal>
                          <DropdownMenuSubContent>
                            ...
                            <DropdownMenuItem onClick={() => onRoleChange(member.id, MemberRole.MODERATER)}>
                              <ShieldCheck className="h-4 w-4 mr-2" />
                              Moderator
                              {member.role === MemberRole.MODERATER && (
                                <Check className="h-4 w-4 ml-auto" />
                              )}
                            </DropdownMenuItem>
                          </DropdownMenuSubContent>
